...
namespace RetrivalManagement.Infrastructure.Security
{
    public class ApplicationTokenProvider : IApplicationTokenProvider
    {
        ...
        public async Task<string> RefereshTokenAsync(User user, UserConfig userConfig)
        {
        ...
        private void AddCookie(User user, string value)
        {
    ...
    public interface IApplicationTokenProvider
    {
        ...
        Task<string> RefereshTokenAsync(User user, UserConfig userConfig);
